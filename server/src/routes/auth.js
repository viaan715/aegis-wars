...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const user = await queryOne(
      'INSERT INTO users (email, password_hash, name, plan, credits) VALUES ($1, $2, $3, $4, $5) RETURNING id, email, name, plan, credits',
      [normalizedEmail, passwordHash, name.trim(), 'free', STARTER_CREDITS]
    );
